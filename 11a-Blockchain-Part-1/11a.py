...
class Block():
    ...
    def load_a_block(self, fh):
        ...
        if self.index>=128447 and self.index<=128450:
            print(self)
        #sha2546hasher = MD5.new()
        #sha2546hash=sha2546hasher.update(self)
        #Sif sha2546hash == '58a3b9335a6ceb0234c12d35a0564c4ef0e90152d0eb2ce2082383b38028a90f':
        #    print(self)
        return self
